"""ssec-Sentinel Main Application - COMPLETE VERSION WITH FLIGHTS & HEATMAP"""
import sys
import os
...
async def get_flights_near_disaster(disaster_id: str, radius: float = 100):
    """Get flights near a specific disaster (mock for now)"""
...
# ==================== MOCK DISASTER DATA (Original) ====================
@app.get("/ssec/api/disasters")
async def get_mock_disasters():
    """Original mock disaster data"""
    return [
        {
            "id": "EQ12345",
...
async def get_dashboard_data(country: Optional[str] = None):
    ...
    try:
        ...
        stats = {
            ...
            "emergency_flights": len([f for f in flights_near if f.get("is_emergency")]),
...
if __name__ == "__main__":
    ...
    print("  • GET  /ssec/api/flights/near")
    print("  • GET  /ssec/api/flights/emergency")
    print("  • GET  /ssec/api/flights/near-disaster/{id}")
    print("  • GET  /ssec/api/heatmap")
    print("  • GET  /ssec/api/heatmap/conflicts")
    print("  • GET  /ssec/api/heatmap/natural")
    print("  • GET  /ssec/api/heatmap/grid")
    print("  • GET  /ssec/api/heatmap/timeline")
    print("  • GET  /ssec/api/heatmap/stats")
